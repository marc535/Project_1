	...
	if (!App->is_paused) {
		...
		case CROUCH_KICK:
			...
			if (flip == SDL_FLIP_HORIZONTAL) {
				...
				if (collider_player_attack == nullptr) {
					collider_player_attack = App->collision->AddCollider({ position.x - 50, position.y - 10,100,20 }, COLLIDER_PLAYER_ATTACK, (Module*)App->player);
					collider_player_attack->SetSize(85, 15);
				}
			}
			else {
				...
				if (collider_player_attack == nullptr) {
					collider_player_attack = App->collision->AddCollider({ position.x + 25, position.y - 10,100,20 }, COLLIDER_PLAYER_ATTACK, (Module*)App->player);
					collider_player_attack->SetSize(85, 15);
				}
		...
		case CROUCH_PUNCH:
			...
			if (flip == SDL_FLIP_HORIZONTAL) {
				...
				if (collider_player_attack == nullptr)
				{
					collider_player_attack = App->collision->AddCollider({ position.x - 50, position.y - 50,80,40 }, COLLIDER_PLAYER_ATTACK, (Module*)App->player);
				}
				...
				if (collider_player_attack == nullptr)
				{
					collider_player_attack = App->collision->AddCollider({ position.x + 55, position.y - 50,80,40 }, COLLIDER_PLAYER_ATTACK, (Module*)App->player);
				}
			}
		...
		case JUMP_PUNCH:
			...
			if (flip == SDL_FLIP_HORIZONTAL) {
				...
				if (collider_player_attack == nullptr)
				{
					collider_player_attack = App->collision->AddCollider({ position.x, position.y,78,40 }, COLLIDER_PLAYER_ATTACK, (Module*)App->player2);
		...
		case JUMP_KICK:
			...
			if (flip == SDL_FLIP_HORIZONTAL) {
				...
				if (collider_player_attack == nullptr)
				{
					collider_player_attack = App->collision->AddCollider({ position.x, position.y,80,40 }, COLLIDER_PLAYER_ATTACK, (Module*)App->player);
		...
		case KICK:
			...
			*/
			...
			if (flip == SDL_FLIP_HORIZONTAL) {
				...
				if (collider_player_attack == nullptr)
				{
					collider_player_attack = App->collision->AddCollider({ position.x, position.y,80,40 }, COLLIDER_PLAYER_ATTACK, (Module*)App->player2);
					collider_player_attack->SetPos(position.x - 50, position.y - 70);
					collider_player_attack->SetSize(45, 50);
				}
			}
			...
			*/
			...
			if (flip == SDL_FLIP_HORIZONTAL) {
				...
				if (current_animation->SeeCurrentFrame() == 14 && !are_particles_created) {
					App->particles->AddParticle(App->particles->tornado, position.x - 50, position.y, COLLIDER_PLAYER_SHOT);
